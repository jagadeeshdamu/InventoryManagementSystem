...
public class PurchaseOrders {
    ...
    public void addDetails() throws SQLException {
        ...
        purchaseOrder.setPrice(Double.parseDouble(sc.nextLine()));

        System.out.print("Enter quantity: ");
        purchaseOrder.setQuantity(Integer.parseInt(sc.nextLine()));

        purchaseOrderDao.add(purchaseOrder);
        System.out.println("Purchase order details inserted successfully.");
    }
    ...
    public void retrieveAllDetails() throws SQLException {
        ...
        System.out.println(purchaseOrderDao.getAll());
    }
    ...
    public void updateDetails() throws SQLException {
        ...
        if (!newPriceStr.isEmpty()) {
            ...
            existingPurchaseOrder.setPrice(newPrice);
        }
    ...
    public void deleteDetail() throws SQLException {
        ...
        System.out.println("Purchase order with ID " + purchaseOrderId + " deleted successfully.");
    }
